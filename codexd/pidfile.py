...
def is_process_alive(pid: int) -> bool:
    ...
    try:
        # signal 0 is a portable POSIX liveness probe; it does not affect the
        # target process. SonarCloud S4828 still flags this site — marked SAFE
        # in the project's hotspot review (see docs/migration receipt log).
